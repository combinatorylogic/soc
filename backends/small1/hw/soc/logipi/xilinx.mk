# xilinx.mk is taken from http://excamera.com/sphinx/fpga-makefile.html
#
...
$(project).twr: $(project)_par.ncd
	$(xil_env); trce -v 5 $< $(project).pcf -o $(project).twr
