...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { sys_clk_in }]; #IO_L12P_T1_MRCC_35 Sch=sys_clk_in
...
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { sys_reset }]; #IO_L3P_T0_DQS_AD1P_15 Sch=sys_reset
...
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { pwm_out }]; #IO_L4N_T0_15 Sch=pwm_out
